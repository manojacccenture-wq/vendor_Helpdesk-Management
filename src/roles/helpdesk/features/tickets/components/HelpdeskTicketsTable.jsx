                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      <button 
                        ...
                        className="text-primary border border-default px-4 py-2 rounded-control hover:bg-surface-hover transition-colors"
                      >
                        View Details
                      </button>
                      <button className="text-white bg-primary px-4 py-2 rounded-control hover:bg-primary-hover transition-colors">
                        Assign to Me
                      </button>
                    </div>
                  </td>
