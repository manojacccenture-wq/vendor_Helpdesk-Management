...
export const Header = ({ portalName = "Vendor helpdesk portal" }) => {
  ...
  return (
    <header className="h-[64px] bg-[#1E293B] flex items-center justify-between px-6 shrink-0 w-full">
      {/* Left: Branding */}
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-[8px] border border-white/20 bg-white/10 flex items-center justify-center">
          <span className="text-white font-[600] text-[14px]">TS</span>
        </div>
        <div className="flex flex-col">
          <h1 className="text-white text-[15px] font-[600] leading-tight">
            Tata Steel Utilities and Infrastructure Services Limited
          </h1>
          <p className="text-slate-400 text-[12px] font-[400]">
            {portalName}
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative cursor-pointer w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full border border-[#1E293B]"></span>
        </div>
        
        {/* Profile */}
        <div className="flex items-center gap-2 cursor-pointer">
          <div className="w-8 h-8 rounded-full bg-slate-500 flex items-center justify-center">
            <span className="text-white font-[500] text-[13px]">
